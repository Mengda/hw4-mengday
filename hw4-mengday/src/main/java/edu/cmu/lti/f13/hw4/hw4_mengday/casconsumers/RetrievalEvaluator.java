package edu.cmu.lti.f13.hw4.hw4_mengday.casconsumers;
...
public class RetrievalEvaluator extends CasConsumer_ImplBase {
  ...
  public void processCas(CAS aCas) throws ResourceProcessException {
    ...
    if (it.hasNext()) {
      ...
      // Add tokenListMaps to their corresponding HashMaps.
      if (Rel == 99) {
  ...
  /**
   * Calculate the cosine similarity of two Token Lists. The dimensions are the words and the value
   * of each dimension is their corresponding frequency.
   * 
  ...
  /**
   * Compute the MRR over all the quries.
   * @return mrr
   */
